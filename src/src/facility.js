let facilityElems = document.querySelectorAll('.progress-bar');
let facilityHeaders = document.querySelectorAll('.progress-bar-header');
let facilityTexts = document.querySelectorAll('.progress-bar-percent');
let widths = [1, 1, 1, 1];
